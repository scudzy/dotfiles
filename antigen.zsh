...
if [[ $ANTIGEN_CACHE != false ]]; then
  ANTIGEN_CACHE="${ANTIGEN_CACHE:-${ADOTDIR:-$HOME/dotfiles/.antigen}/init.zsh}"
  ANTIGEN_RSRC="${ANTIGEN_RSRC:-${ADOTDIR:-$HOME/dotfiles/.antigen}/.resources}"
...
-antigen-env-setup () {
  ...
  -antigen-set-default ADOTDIR $HOME/dotfiles/.antigen
...
ANTIGEN_DEBUG_LOG=${ANTIGEN_DEBUG_LOG:-${ADOTDIR:-$HOME/dotfiles/.antigen}/debug.log}
LOG () {
